...
export class ArchiveOrUnarchiveProductController extends iController {
  constructor(private readonly archiveOrUnarchiveProduct: iArchiveOrUnarchiveProductUsecase, private readonly NotificationErrorDriver: INotificationErrorDriver) {
    super();
  }
  async exec(request: HttpRequest): Promise<HttpResponse> {
    try {
      ...
      ObjectManager.hasKeysWithNotification<iArchiveOrUnarchiveProductUsecase.Input>(['action', 'product_id'], content, notificationError);
