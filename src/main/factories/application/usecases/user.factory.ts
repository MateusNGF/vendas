import { SignInAccountUserData, SignUpAccountUserData, GetAccountUserData } from '../../../../data/usecases/user';
import { iSignInAccountUserUsecase, iSignUpAccountUserUsecase, iGetAccountUserUsecase } from 'src/domain/usecases/user';
...
export function makeSignUpAccountUserUsecase(): iSignUpAccountUserUsecase {
  return new SignUpAccountUserData(makeUserRepository(), makeCreateAuthenticateUsecase(), makeCreateTokenAuthenticateUsecase());
}
