...
export class CreateIncomingTransactionForProductsData implements iCreateIncomingTransactionForProductsUsecase {
    constructor(
    ...
    async exec(input: iCreateIncomingTransactionForProductsUsecase.Input) {
        ...
        try{
            ...
            for (let i = 0; i < products.length; i++) {
                ...
                transactionPartial.products.push(this.makeProductContentTransaction(productBasic, productContent))
